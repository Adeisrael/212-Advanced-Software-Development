...
namespace HarrisContactWeb.Controllers
{
    public class BusinessContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessEmail,BusinessTel,BusinessAdrr1,BusinessAddr2,BusinessCity,BuisnessPostCode")] BusinessContact businessContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusinessContactID,BusinessFname,BusinessLname,BusinessEmail,BusinessTel,BusinessAdrr1,BusinessAddr2,BusinessCity,BuisnessPostCode")] BusinessContact businessContact)
        {
