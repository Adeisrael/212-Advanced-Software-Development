...
namespace HarrisContactWeb.Controllers
{
    public class PersonalContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PersonalContactID,PersonalFname,PersonsalLname,PersonalEmail,HomeTel,PersonalAddr1,PersonalAddr2,PersonalCity,PersonalPostCode")] PersonalContact personalContact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalContactID,PersonalFname,PersonsalLname,PersonalEmail,HomeTel,PersonalAddr1,PersonalAddr2,PersonalCity,PersonalPostCode")] PersonalContact personalContact)
        {
